...
\lstinputlisting[language=tex]{files/lesson-plan/getting-started/example1.tex}
...
\lstinputlisting[language=tex, caption={Caption}]{"./files/lesson-plan/getting-started/example2.tex"}
